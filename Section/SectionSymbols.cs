...
{
    public class SectionSymbols
    {
        public static readonly string CODE_SECTION_NAME = ".text";
        public static readonly string RESOURCE_SECTION_NAME = ".rsrc";
        public static readonly int SECTION_NAME_SIZE = 8;
        public static readonly int SECTION_SIZE = 0x28;
    }
}
